$(function(){
	...
	/*
	 * Adds a group of random students generated by the API
	 */
	function addRandomStudents(numOfStudents) {
		var counter = 0;
		while (counter <= numOfStudents) {
			$.ajax({
				type: 'GET',
				url: "http://beta.randomapi.com/api/050e939c2a1cb413a55598e127437de0",
				dataType: 'json',
				success: function(data) {
					$.ajax({
						type: 'POST',
